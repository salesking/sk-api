...
This gem provides an api client using ActiveResource. As our schema has evolved this client does not support the full API anymore.
We have setup a new SDK project https://github.com/salesking/sk_sdk wich will replace this.

The rest of this doc is still valid and should be read, even if you are using another language or your own client.

Additional resources:

* http://dev.blog.salesking.eu/docs/
* https://github.com/salesking/sk_api_schema/tree/master/json/v1.0
...
SalesKing's api interface is RESTful(mostly) and talks JSON only.
...
* Chrome JSON Viewer: https://chrome.google.com/extensions/search?itemlang=&hl=de&q=json
    ...
    class SomeMiddleware
      ...
      def set_api_connection
        SKApi::Resources::Base.set_connection({
          :site     => 'https://my_sub.salesking.eu',
